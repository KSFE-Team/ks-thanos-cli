...
export default class FormConfig extends Component<FormConfigProps> {
    ...
    getTypeForm = () => {
        ...
        //         return (
        //             <>
        //                 <FormItem label="新增API" {...formItemLayout} required>
        //                     <Input
        //                         placeholder="新增API"
        ...
        //                     />
        //                 </FormItem>
        //                 <FormItem label="修改API" {...formItemLayout} required>
        //                     <Input
        //                         placeholder="修改API"
        ...
        //                     />
        //                 </FormItem>
        //                 <FormItem label="查询API" {...formItemLayout} required>
        //                     <Input
        //                         placeholder="查询API"
        ...
        //                     />
        //                 </FormItem>
        //                 <FormItem label="路由参数" {...formItemLayout} required>
        //                     <Input
        //                         placeholder="路由参数"
